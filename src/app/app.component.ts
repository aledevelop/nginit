      ...
      <div class="container">
        <div class="popup">
          <div class="item-row">
              ...
              <div class="alert alert-danger" *ngIf="!this.name?.errors || (!this.name?.dirty && !this.name?.touched)">
                <div>&nbsp;</div>
              </div>
          </div>
          <div class="item-row">
            ...
            <div class="alert alert-danger" *ngIf="!this.packageManager?.errors || (!this.packageManager?.dirty && !this.packageManager?.touched)">
                <div>&nbsp;</div>
            </div>
          </div>
          <div class="item-row">
            ...
            <div class="alert alert-danger" *ngIf="!this.style?.errors || (!this.style?.dirty && !this.style?.touched)">
                <div>&nbsp;</div>
            </div>
          </div>
          <div class="item-row">
